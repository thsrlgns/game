...
def add_file():
    files= filedialog.askopenfilenames(title="이미지 파일을 선택하세요", \
        ...
        initialdir="C:/Users/gary0/OneDrive/바탕화면")
    for file in files:
...
def start():
    ...
    if len(txt_dest_path.get())==0:
        msgbox.showwarning("경고", "저장경로를 추가하세요")
        return
...
list_file= Listbox(list_frame, selectmode="extendend", height=15, yscrollcommand=scrollbar.set)
